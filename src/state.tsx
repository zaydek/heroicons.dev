...
export function StateProvider({ children }: PropsWithChildren) {
	const [size, setSize] = useState(() => searchParams.number({ key: "size", min: 0, max: 60, initialValue: 30 }))
	const [strokeWidth, setStrokeWidth] = useState(() => searchParams.number({ key: "strokeWidth", min: 0, max: 4, initialValue: 2 }))
	...
	const [framework, setFramework] = useState(() => searchParams.string<FrameworkValue>({ key: "framework", oneOf: Frameworks, initialValue: "svg" }))
