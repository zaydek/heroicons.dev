...
const ExtLinksFragment = () => (
	<>
		...
		<a className="block" href="https://github.com/codex-src/heroicons.dev" {...attrs.target_blank}>
			<p className="flex flex-row items-center font-medium text-gray-100">
				<svg className="mr-2 w-5 h-5 fill-current text-yellow-200 transform scale-90" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width="16" height="16">
		...
		<a className="block" href="https://github.com/sponsors/codex-zaydek" {...attrs.target_blank}>
			<p className="flex flex-row items-center font-medium text-gray-100">
				<svg className="mr-2 w-5 h-5 fill-current transform scale-90" style={{ color: "rgb(234, 74, 170)" }} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width="16" height="16">
