...
const originalIcons = [
	...
	{
		name: "cog",
		tags: createTags(...categories.settings, "cog"),
	...
	{
		name: "color-swatch",
		tags: createTags("color-swatch", "color", "swatch", "3d"),
		solid: Hero.ColorSwatchSolidSm,
		outline: Hero.ColorSwatchOutlineMd,
	},
	{
		name: "credit-card",
		tags: createTags(...categories.currency, ...categories.shopping, "credit-card", "credit", "card"),
		solid: Hero.CreditCardSolidSm,
		outline: Hero.CreditCardOutlineMd,
	},
	{
		name: "currency-dollar",
		tags: createTags(...categories.currency, ...categories.shopping, "currency-dollar", "currency", "dollar"),
		solid: Hero.CurrencyDollarSolidSm,
		outline: Hero.CurrencyDollarOutlineMd,
	},
	{
		name: "currency-euro",
		tags: createTags(...categories.currency, "currency-euro", "currency", "euro"),
		solid: Hero.CurrencyEuroSolidSm,
		outline: Hero.CurrencyEuroOutlineMd,
	},
	{
		name: "currency-pound",
		tags: createTags(...categories.currency, "currency-pound", "currency", "pound"),
		solid: Hero.CurrencyPoundSolidSm,
		outline: Hero.CurrencyPoundOutlineMd,
	},
	{
		name: "currency-rupee",
		tags: createTags(...categories.currency, "currency-rupee", "currency", "rupee"),
		solid: Hero.CurrencyRupeeSolidSm,
		outline: Hero.CurrencyRupeeOutlineMd,
	},
	{
		name: "currency-yen",
		tags: createTags(...categories.currency, "currency-yen", "currency", "yen"),
		solid: Hero.CurrencyYenSolidSm,
		outline: Hero.CurrencyYenOutlineMd,
	},
	{
		name: "cursor-click",
		tags: createTags(...categories.new, ...categories.pointer, "cursor-click", "cursor", "click"),
		solid: Hero.CursorClickSolidSm,
		outline: Hero.CursorClickOutlineMd,
	},
	{
		name: "document-add",
		tags: createTags(...categories.add, ...categories.file, "document-add", "document", "add"),
		solid: Hero.DocumentAddSolidSm,
		outline: Hero.DocumentAddOutlineMd,
	},
	{
		name: "document-download",
		tags: createTags(...categories.file, "document-download", "document", "download"),
		solid: Hero.DocumentDownloadSolidSm,
		outline: Hero.DocumentDownloadOutlineMd,
	},
	{
		name: "document-duplicate",
		tags: createTags(...categories.copypasta, ...categories.file, "document-duplicate", "document", "duplicate"),
		solid: Hero.DocumentDuplicateSolidSm,
		outline: Hero.DocumentDuplicateOutlineMd,
	},
	{
		name: "document-remove",
		tags: createTags(...categories.file, "document-remove", "document", "remove"),
		solid: Hero.DocumentRemoveSolidSm,
		outline: Hero.DocumentRemoveOutlineMd,
	},
	{
		name: "document-report",
		tags: createTags(...categories.file, ...categories.new, ...categories.stats, "document-report", "document", "report"),
		solid: Hero.DocumentReportSolidSm,
		outline: Hero.DocumentReportOutlineMd,
	},
	{
		name: "document",
		tags: createTags(...categories.file, "document"),
		solid: Hero.DocumentSolidSm,
		outline: Hero.DocumentOutlineMd,
	},
	{
		name: "dots-circle-horizontal",
		tags: createTags(...categories.ellisis, ...categories.more, "dots-circle-horizontal", "dots", "circle", "horizontal"),
		solid: Hero.DotsCircleHorizontalSolidSm,
		outline: Hero.DotsCircleHorizontalOutlineMd,
	},
	{
		name: "dots-horizontal",
		tags: createTags(...categories.ellisis, ...categories.more, "dots-horizontal", "dots", "horizontal"),
		solid: Hero.DotsHorizontalSolidSm,
		outline: Hero.DotsHorizontalOutlineMd,
	},
	{
		name: "dots-vertical",
		tags: createTags(...categories.ellisis, ...categories.more, "dots-vertical", "dots", "vertical"),
	...
	{
		name: "duplicate",
		tags: createTags(...categories.copypasta, "duplicate"),
		solid: Hero.DuplicateSolidSm,
		outline: Hero.DuplicateOutlineMd,
	},
	{
		name: "emoji-happy",
		tags: createTags(...categories.emotions, ...categories.people, "emoji-happy", "emoji", "happy"),
		solid: Hero.EmojiHappySolidSm,
		outline: Hero.EmojiHappyOutlineMd,
	},
	{
		name: "emoji-sad",
		tags: createTags(...categories.emotions, ...categories.people, "emoji-sad", "emoji", "sad"),
		solid: Hero.EmojiSadSolidSm,
		outline: Hero.EmojiSadOutlineMd,
	},
	{
		name: "exclamation-circle",
		tags: createTags(...categories.delete, "exclamation-circle", "exclamation", "circle"),
		solid: Hero.ExclamationCircleSolidSm,
		outline: Hero.ExclamationCircleOutlineMd,
	},
	{
		name: "exclamation",
		tags: createTags(...categories.delete, "exclamation"),
		solid: Hero.ExclamationSolidSm,
		outline: Hero.ExclamationOutlineMd,
	},
	{
		name: "external-link",
		tags: createTags(...categories.share, "external-link", "external", "link"),
		solid: Hero.ExternalLinkSolidSm,
		outline: Hero.ExternalLinkOutlineMd,
	},
	{
		name: "eye",
		tags: createTags(...categories.password, "eye", "reveal"),
	...
	{
		name: "folder",
		tags: createTags(...categories.folder, "folder"),
		solid: Hero.FolderSolidSm,
		outline: Hero.FolderOutlineMd,
	},
	{
		name: "globe-alt",
		tags: createTags(...categories.world, "globe-alt", "globe", "alt"),
		solid: Hero.GlobeAltSolidSm,
		outline: Hero.GlobeAltOutlineMd,
	},
	{
		name: "globe",
		tags: createTags(...categories.world, "globe"),
	...
	{
		name: "user-add",
		tags: createTags(...categories.people, ...categories.add, "user-add", "user", "add"),
		solid: Hero.UserAddSolidSm,
		outline: Hero.UserAddOutlineMd,
	},
	{
		name: "user-circle",
		tags: createTags(...categories.people, "user-circle", "user", "circle"),
		solid: Hero.UserCircleSolidSm,
		outline: Hero.UserCircleOutlineMd,
	},
	{
		name: "user-group",
		tags: createTags(...categories.people, "user-group", "user", "group", "company"),
		solid: Hero.UserGroupSolidSm,
		outline: Hero.UserGroupOutlineMd,
	},
	{
		name: "user-remove",
		tags: createTags(...categories.delete, ...categories.people, "user-remove", "user", "remove"),
		solid: Hero.UserRemoveSolidSm,
		outline: Hero.UserRemoveOutlineMd,
	},
	{
		name: "user",
		tags: createTags(...categories.people, "user"),
		solid: Hero.UserSolidSm,
		outline: Hero.UserOutlineMd,
	},
	{
		name: "users",
		tags: createTags(...categories.people, "users", "company"),
		solid: Hero.UsersSolidSm,
		outline: Hero.UsersOutlineMd,
	},
	{
		name: "view-boards",
		tags: createTags(...categories.layout, "view-boards", "view", "boards"),
		solid: Hero.ViewBoardsSolidSm,
		outline: Hero.ViewBoardsOutlineMd,
	},
	{
		name: "view-list",
		tags: createTags(...categories.layout, "view-list", "view", "list"),
		solid: Hero.ViewListSolidSm,
		outline: Hero.ViewListOutlineMd,
	},
	{
		name: "volume-off",
		tags: createTags("volume-off", "volume", "off", "sound", "speaker", ["quiet", "loud"]),
		solid: Hero.VolumeOffSolidSm,
		outline: Hero.VolumeOffOutlineMd,
	},
	{
		name: "volume-up",
		tags: createTags("volume-up", "volume", "up", "sound", "speaker", ["quiet", "loud"]),
		solid: Hero.VolumeUpSolidSm,
		outline: Hero.VolumeUpOutlineMd,
	},
	{
		name: "x-circle",
		tags: createTags(...categories.delete, "x-circle", "x", "circle"),
		solid: Hero.XCircleSolidSm,
		outline: Hero.XCircleOutlineMd,
	},
	{
		name: "x",
		tags: createTags(...categories.delete, "x"),
		solid: Hero.XSolidSm,
		outline: Hero.XOutlineMd,
	},
	{
		name: "zoom-in",
		tags: createTags("zoom-in", "zoom", "in", "magnify"),
		solid: Hero.ZoomInSolidSm,
		outline: Hero.ZoomInOutlineMd,
	},
	{
		name: "zoom-out",
		tags: createTags("zoom-out", "zoom", "out", "magnify"),
