...
// https://unpkg.com/heroicons@2.0.13/20/solid/magnifying-glass-plus.svg
export function MagnifyingGlassPlus(props: SVGAttributes<SVGElement>) {
	return (
		<svg fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" {...props}>
			...
			<path clipRule="evenodd" fillRule="evenodd" d="M2 9a7 7 0 1112.452 4.391l3.328 3.329a.75.75 0 11-1.06 1.06l-3.329-3.328A7 7 0 012 9zm7-5.5a5.5 5.5 0 100 11 5.5 5.5 0 000-11z" />
		</svg>
	)
}
