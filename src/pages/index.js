			...
			<div className="absolute right-0 inset-y-0">
				<div className="-mx-1.5 px-8 pl-3 flex flex-row h-full">
					...
					<div className="px-1.5 flex flex-row items-center">
						<Apply className="p-1 w-8 h-8 text-purple-400 bg-purple-100 rounded-full overflow-visible">
							{/* <SVGFlagOutline /> */}
					...
					<div className="px-1.5 flex flex-row items-center">
						<Apply className="p-1 w-8 h-8 text-purple-400 bg-purple-100 rounded-full">
