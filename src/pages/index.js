...
html {
	--twemoji-animation-name: animate-twemoji-eyes;
	--twemoji-animation-duration: 500ms;
}
.animated-twemoji .animate-twemoji-eyes {
	animation: var(--twemoji-animation-name) var(--twemoji-animation-duration) cubic-bezier(0.4, 0, 0.2, 1) infinite;
}
.animated-twemoji:hover {
	--twemoji-animation-name: animate-twemoji-eyes-over-9000;
	--twemoji-animation-duration: 300ms;
}

@keyframes animate-twemoji-eyes {
	0%, 100% {
		transform: scale(1);
	}
	50% {
...
@keyframes animate-twemoji-eyes-over-9000 {
	0%, 100% {
		transform: scale(1);
	}
	50% {
...
`}
			...
			<a href="TODO" {...target_blank}>
				<p className="animated-twemoji px-4 py-0.5 pt-4 font-medium no-underline hover:underline text-purple-50">
					<span className="inline-flex flex-row items-center">
						<Apply className="relative w-6 h-6 overflow-visible">
							<svg viewBox="0 0 36 36" xmlns="http://www.w3.org/2000/svg">
								...
								<Apply className="animate-twemoji-eyes origin-center">
									<path fill="#dd2e44" d="M16.65 3.281C15.791.85 13.126-.426 10.694.431c-1.476.52-2.521 1.711-2.928 3.104-1.191-.829-2.751-1.1-4.225-.58C1.111 3.813-.167 6.48.692 8.911c.122.344.284.663.472.958 1.951 3.582 7.588 6.1 11.001 6.131 2.637-2.167 5.446-7.665 4.718-11.677-.038-.348-.113-.698-.233-1.042zm2.7 0C20.209.85 22.875-.426 25.306.431c1.476.52 2.521 1.711 2.929 3.104 1.191-.829 2.751-1.1 4.225-.58 2.43.858 3.707 3.525 2.85 5.956-.123.344-.284.663-.473.958-1.951 3.582-7.588 6.1-11.002 6.131-2.637-2.167-5.445-7.665-4.717-11.677.037-.348.112-.698.232-1.042z" />
								</Apply>
							</svg>
						</Apply>
			...
			{/* GitHub */}
			<a href="TODO" {...target_blank}>
				<p className="animated-twemoji px-4 py-0.5 pb-4 font-medium no-underline hover:underline text-purple-50">
					<span className="inline-flex flex-row items-center">
